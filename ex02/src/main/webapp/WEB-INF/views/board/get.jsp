...
<div class="container-fluid">
	...
	<div class="card shadow mb-4">
		...
		<div class="card-body">
			...
			<a data-oper="modify" class="btn btn-primary btn-sm"
				href="/board/modify?bno=${board.bno }">Modify</a> <a
				data-oper="list" class="btn btn-primary btn-sm" href="/board/list">List</a>
			<!--페이징 처리  -->
